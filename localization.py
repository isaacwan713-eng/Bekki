...
TEXT = {
    "zh-CN": {
        ...
        "identity_company": "不是哦。Bekki 是 YW49 创建和维护的本地个人 AI 助手，不是 OpenAI、ChatGPT 或其他 AI 公司的官方产品。普通聊天目前通过本地 Ollama 调用 Gemma 4 12B 来生成回复 🩵",
        "identity_model": "我现在通过本地 Ollama 运行：主要回答和图片理解使用 Gemma 4 12B，快速路由与审计使用 Gemma 4 E4B。它们是 Bekki 的底层模型，Bekki 本身由 YW49 创建和维护 ✨",
        ...
        "appearance": "外观设置", "appearance_title": "让 Bekki 更像你喜欢的样子",
        "appearance_subtitle": "调整聊天字体、字号与 Bekki 头像；保存后立即应用。",
        "chat_font": "聊天字体", "chat_font_size": "文字大小",
        "choose_avatar": "更换头像", "default_avatar": "使用默认头像",
        "preview": "预览", "appearance_preview_text": "你好呀，我是 Bekki 🩵 这样看起来舒服吗？",
        "restore_defaults": "恢复默认", "save": "保存", "cancel": "取消",
        "appearance_saved": "外观设置已保存 ✨",
        "appearance_save_failed": "外观设置保存失败：{error}",
        "invalid_avatar": "这个图片无法作为头像读取，请换一张图片。",
    },
    "en": {
        ...
        "identity_company": "No. Bekki is a local personal AI assistant created and maintained by YW49, not an official product of OpenAI, ChatGPT, or another AI company. Normal chat currently runs Gemma 4 12B locally through Ollama 🩵",
        "identity_model": "I run locally through Ollama: primary answers and image understanding use Gemma 4 12B, while fast routing and audits use Gemma 4 E4B. They are Bekki's underlying models; Bekki is created and maintained by YW49 ✨",
        ...
        "appearance": "Appearance", "appearance_title": "Make Bekki feel like yours",
        "appearance_subtitle": "Adjust the chat font, text size, and Bekki avatar. Changes apply after saving.",
        "chat_font": "Chat font", "chat_font_size": "Text size",
        "choose_avatar": "Choose avatar", "default_avatar": "Use default avatar",
        "preview": "Preview", "appearance_preview_text": "Hi, I'm Bekki 🩵 Does this feel comfortable?",
        "restore_defaults": "Restore defaults", "save": "Save", "cancel": "Cancel",
        "appearance_saved": "Appearance saved ✨",
        "appearance_save_failed": "Could not save appearance: {error}",
        "invalid_avatar": "This image could not be read as an avatar. Choose another image.",
    },
    "es": {
        ...
        "identity_company": "No. Bekki es una asistente personal local creada y mantenida por YW49; no es un producto oficial de OpenAI, ChatGPT ni de otra empresa de IA. El chat normal usa Gemma 4 12B localmente mediante Ollama 🩵",
        "identity_model": "Funciono localmente mediante Ollama: las respuestas principales y la visión usan Gemma 4 12B, y el enrutamiento rápido usa Gemma 4 E4B. Son los modelos subyacentes de Bekki; YW49 crea y mantiene Bekki ✨",
        ...
        "appearance": "Apariencia", "appearance_title": "Personaliza a Bekki",
        "appearance_subtitle": "Ajusta la fuente, el tamaño del texto y el avatar de Bekki.",
        "chat_font": "Fuente del chat", "chat_font_size": "Tamaño del texto",
        "choose_avatar": "Elegir avatar", "default_avatar": "Usar avatar predeterminado",
        "preview": "Vista previa", "appearance_preview_text": "Hola, soy Bekki 🩵 ¿Se ve cómodo así?",
        "restore_defaults": "Restaurar", "save": "Guardar", "cancel": "Cancelar",
        "appearance_saved": "Apariencia guardada ✨",
        "appearance_save_failed": "No se pudo guardar la apariencia: {error}",
        "invalid_avatar": "No se pudo leer esta imagen como avatar. Elige otra.",
    ...
    "ja": {
        ...
        "identity_company": "いいえ。BekkiはYW49が開発・保守するローカル個人AIアシスタントであり、OpenAI、ChatGPT、その他AI企業の公式製品ではありません。通常のチャットはOllama経由でGemma 4 12Bを使用します 🩵",
        "identity_model": "Ollamaを通じてローカルで動作しています。主要な応答と画像理解はGemma 4 12B、高速ルーティングと監査はGemma 4 E4Bを使用します。これらは基盤モデルで、BekkiはYW49が開発・保守しています ✨",
        ...
        "appearance": "外観設定", "appearance_title": "Bekkiを好みの見た目に",
        "appearance_subtitle": "チャットのフォント、文字サイズ、Bekkiのアバターを調整します。",
        "chat_font": "チャットフォント", "chat_font_size": "文字サイズ",
        "choose_avatar": "アバターを選択", "default_avatar": "既定のアバター",
        "preview": "プレビュー", "appearance_preview_text": "こんにちは、Bekkiです 🩵 見やすいですか？",
        "restore_defaults": "既定に戻す", "save": "保存", "cancel": "キャンセル",
        "appearance_saved": "外観設定を保存しました ✨",
        "appearance_save_failed": "外観設定を保存できませんでした：{error}",
        "invalid_avatar": "この画像をアバターとして読み取れません。別の画像を選んでください。",
